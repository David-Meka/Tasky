...
import 'package:taskly/pages/tasks_veiw.dart';
import 'package:taskly/widgets/circular_progress.dart';
...
class TaskProgress extends StatelessWidget {
  ...
  //TODO the task progress indicates progress for each day
  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.all(8.0),
            ...
            children: [
              GestureDetector(
                onTap: () => Navigator.push(context,
                    MaterialPageRoute(builder: (context) => const TasksVeiw())),
                child: Container(
                  height: 300,
                  width: 159.0,
                  decoration: BoxDecoration(
